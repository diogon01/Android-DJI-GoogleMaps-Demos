...
public class MainActivity extends FragmentActivity implements View.OnClickListener,
    ...
    //Adicionar ouvinte para WaypointMissionOperator
    ...
    private void setUpMap() {
        // Adiciona um ouvinte(listerner) de clique para o objeto do mapa
    ...
    public void onMapClick(LatLng point) {
        if (isAdd) {
            ...
            // Adicionar Waypoints ao waypoint arraylist;
    ...
    // Atualize a localização do drone com base nos estados do MCU.
